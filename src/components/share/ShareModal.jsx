...
export default function ShareModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl bg-white border-slate-200 text-slate-900 p-6 overflow-hidden">
        <DialogHeader>
        ...
        <div className="flex items-center justify-between bg-white border border-slate-200 p-3 rounded-xl mt-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-800">Anonymizácia osobných údajov</p>
          ...
          <Button
            ...
            className={anonymized ? "bg-amber-500 hover:bg-amber-600 text-slate-950 font-semibold" : "border-slate-300 text-slate-700"}
          >
        ...
        <div className="relative my-4 w-full bg-white border border-slate-200 rounded-xl overflow-hidden flex items-center justify-center p-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="border-slate-300 hover:bg-white text-slate-800 gap-2"
            >
