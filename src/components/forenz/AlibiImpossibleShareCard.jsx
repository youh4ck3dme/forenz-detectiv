    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-gradient-to-br from-slate-900 via-slate-950 to-indigo-950 rounded-3xl border border-slate-200 shadow-2xl overflow-hidden"
          style={{
            boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(59, 130, 246, 0.1)'
          }}
        >
          {/* Header */}
          <div className="relative px-6 py-5 bg-gradient-to-r from-red-950/20 to-blue-950/20 border-b border-slate-200">
              ...
              <div className="flex items-center gap-2">
                ...
                {validRoutes.length > 1 && (
                  <div className="flex items-center gap-1 bg-slate-50 rounded-xl p-1">
                    <button
                      ...
                      className="p-1.5 rounded-lg text-slate-400 hover:text-slate-900 hover:bg-slate-100 disabled:opacity-40 transition-colors"
                    >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onClose}
                    className="p-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-700 transition-colors"
                  >
          ...
          {selectedRoute && (
            <div className="p-6 space-y-5">
              ...
              <motion.div 
                ...
                className="flex items-center gap-4 p-4 rounded-2xl bg-white/40 border border-slate-200"
              >
                <div 
                  ...
                  {selectedRoute.positions && selectedRoute.positions.length >= 2 && (
                    <div className="space-y-3">
                      <div className="flex items-start gap-3 p-3 rounded-xl bg-blue-950/20 border border-blue-800/40">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-slate-900">Mesto A</p>
                      ...
                      <div className="flex items-start gap-3 p-3 rounded-xl bg-red-950/20 border border-red-800/40">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-slate-900">Mesto B</p>
                          <p className="text-xs text-slate-400 mt-0.5">
              ...
              <motion.div
                ...
                className="p-4 rounded-2xl bg-gradient-to-r from-red-950/10 to-blue-950/10 border border-slate-200"
              >
              ...
              <motion.div
                ...
                className="p-3 rounded-xl bg-gradient-to-r from-red-500/10 to-blue-500/10 border border-slate-300 text-center"
              >
                <motion.p
                  initial={{ opacity: 0 }}
          ...
          {/* Footer */}
          <div className="px-6 py-4 bg-white/40 border-t border-slate-200">
